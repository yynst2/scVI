...
NUMS = 5
FILENAME = "simu_fdr_symsim_7_observed_l_batch_size_128_defensive_sampling_part2"
...
# idx = np.random.choice(len(dataset.X), 64)
SAMPLE_IDX = np.array(
    [
        149,
        3384,
...
if __name__ == "__main__":
    ...
    for scenario in SCENARIOS:
        ...
        for n_hidden in N_HIDDEN_ARR:
            ...
            precision_arr_50 = []
            auc_arr_50 = []
            fdr_controlled_fdr_50 = []
            fdr_controlled_tpr_50 = []
            fdr_controlled_fdr10_50 = []
            fdr_controlled_tpr10_50 = []
            ...
            res = {
                ...
                "all_fdr_gt_50": np.array(all_fdr_gt_50),
                "all_pe_fdr_50": np.array(all_pe_fdr_50),
                "fdr_l1_err_50": np.array(fdr_l1_err_50),
                "fdr_l2_err_50": np.array(fdr_l2_err_50),
                "precision_arr_50": np.array(precision_arr_50),
                "auc_arr_50": np.array(auc_arr_50),
                "fdr_controlled_fdr_50": np.array(fdr_controlled_fdr_50),
                "fdr_controlled_tpr_50": np.array(fdr_controlled_tpr_50),
                "fdr_controlled_fdr10": np.array(fdr_controlled_fdr10),
                "fdr_controlled_tpr10": np.array(fdr_controlled_tpr10),
                "fdr_controlled_fdr10_50": np.array(fdr_controlled_fdr10_50),
                "fdr_controlled_tpr10_50": np.array(fdr_controlled_tpr10_50),
            }
